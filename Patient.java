...
public class Patient implements Comparable<Patient> {
     ...
     * @return int - 0 / >0 if this object priority it higher / <0 if this object
     *         priority is lower
     */
    @Override
    ...
    public boolean equals(Object o) {
        ...
        Patient p = (Patient) o;
        if (p.getcreatedTime() != this.getcreatedTime())
            return false;
        if (p.getPriority() != this.getPriority())
            return false;
        if (p.getId() != this.getId())
            return false;
        if (p.isVip() != this.isVip())
            return false;
        return true;
    }
    ...
    public String toString() {
        String patient = "priority:" + this.priority + "\n" + "isvip:" + this.isVip()
